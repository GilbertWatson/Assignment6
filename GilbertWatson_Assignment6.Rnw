...
$$ Y_i = \Sexpr{fitsum$coefficients["(Intercept)","Estimate"]} + \Sexpr{fitsum$coefficients["(Intercept)","Estimate"]}X_{i1} + \Sexpr{fitsum$coefficients["(Intercept)","Estimate"]}X_{i2} $$
